...
<template>
  ...
  <div> <!-- replace cardinfo with foodImage properties -->
    <div class="card-group p-5" v-for="x in foodImages" :key="index">
          <img :src="x.src" class="img-fluid m-5" style="width: 18rem;">
